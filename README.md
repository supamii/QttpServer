...
<b>libuv.qt</b> is a fork from [node.native](https://github.com/d5/node.native).  For those who want the added benefits of libuv's concurrent connection, it is also an alternative to [QHttpServer](https://github.com/nikhilm/qhttpserver).
